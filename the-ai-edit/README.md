# The AI Edit — Course Playbook

Planning documents for **The AI Edit**, a Skool community for building with AI on purpose instead of going in blind.
...
| `05-claude-vs-chatgpt-model-guide.md` | Which Claude or ChatGPT model to use for which creator job |

All facts were checked on **September 23, 2026**. AI tools change monthly, so re-check model names and costs before recording lessons.
